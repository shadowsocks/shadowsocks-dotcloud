...
(function() {
  var KEY, PORT, config, configContent, decryptTable, encrypt, encryptTable, fs, http, inetAton, inetNtoa, net, server, tables, timeout;
  ...
  server.on('upgrade', function(req, connection, head) {
    ...
    return connection.on("drain", function() {
      if (remote) {
