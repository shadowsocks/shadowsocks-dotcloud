...
(function() {
  var Encryptor, KEY, LOCAL_ADDRESS, METHOD, PORT, REMOTE_PORT, SERVER, args, config, configContent, configFromArgs, fs, getServer, http, inetAton, inetNtoa, k, net, path, server, timeout, v;
