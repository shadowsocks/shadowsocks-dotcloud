...
(function() {
  var Encryptor, KEY, LOCAL_ADDRESS, METHOD, PORT, REMOTE_PORT, SERVER, args, config, configContent, configFromArgs, fs, getServer, http, inetNtoa, k, net, path, server, timeout, v;
